...
import { Command, Constraint, Event, Group, GroupMapping, InformationType, Relationship, State } from '../models';

export const uploadCommandArguments = createAction(
  '[file upload] uploadCommandArguments',
  props<{ collectionId: string, file: File }>()
);

export const uploadCommandArgumentsFailure = createAction(
  '[file upload] uploadCommandArgumentsFailure',
  props<{ error: Error }>()
);
...
export const uploadGroupMappingsFailure  = createAction(
  '[file upload] uploadGroupMappingsFailure',
  props<{ error: Error }>()
);

export const uploadGroupMappingsSuccess = createAction(
  '[file upload] uploadGroupMappingsSuccess',
  props<{ groupMappings: GroupMapping[] }>()
);
